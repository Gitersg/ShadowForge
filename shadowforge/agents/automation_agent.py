"""Automation agent — UI control via PyAutoGUI."""
...
class AutomationAgent(BaseAgent):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            capabilities=["click", "double_click", "type_text", "hotkey", "move_mouse", "screenshot"],
        )
        self.pause = pause
    ...
    def process(self, task: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.screenshot_on_action and action != "screenshot":
    ...
    def _hotkey(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        self.logger.info("Hotkey: %s", "+".join(keys))
    ...
    def _screenshot(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        filepath = self.screenshot_dir / f"auto_{label}_{timestamp}.png"
